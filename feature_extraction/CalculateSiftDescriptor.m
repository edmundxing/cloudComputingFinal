function [database, lenStat] = CalculateSiftDescriptor(rt_img_dir, rt_data_dir, gridSpacing, patchSize, maxImSize, nrml_threshold, ext)
%==========================================================================
...
for ii = 1:length(subfolders),
    ...
    if ~strcmp(subname, '.') & ~strcmp(subname, '..'),
        ...
        frames = dir(fullfile(rt_img_dir, subname, ['*.' ext]));
        ...
        for jj = 1:c_num,
            ...
            siftArr = sp_find_sift_grid_spmllc(I, gridX, gridY, patchSize, 0.8);
            [siftArr, siftlen] = sp_normalize_sift_spmllc(siftArr, nrml_threshold);
